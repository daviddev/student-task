...
use App\Repositories\TargetDataRepository;
use Carbon\Carbon;
...
readonly class StudentService
{
     ...
     * @param TargetDataRepository $targetDataRepository
     */
     ...
     */
    public function listStudents($data): LengthAwarePaginator
    {
        return $this->studentRepository->listStudents($data);
    }
